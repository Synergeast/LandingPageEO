...
import imagePosterRATSWebsite from '../banners/poster-RATS-website-2560x1440.jpg'

const imagesByDevice = {
    mobile: [
        imagePosterRATSWebsite,
        imageOrangLari,
    ...
    return (
        <div className="min-h-screen flex flex-col">
            <div className="flex-1 relative overflow-hidden bg-black/90">
                ...
                {/* This div is now relative to the Header's absolute positioning */}
